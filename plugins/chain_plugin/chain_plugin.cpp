...
public:
   ...
   fc::optional<pbft_controller>    pbft_ctrl;///bos
...
pbft_controller& chain_plugin::pbft_ctrl() { return *my->pbft_ctrl; }///bos
const pbft_controller& chain_plugin::pbft_ctrl() const { return *my->pbft_ctrl; }///bos
