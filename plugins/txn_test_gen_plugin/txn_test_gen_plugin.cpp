...
///bos
  ...
  ///bos end
   ...
   void create_test_accounts(const std::string& init_name, const std::string& init_priv_key, const std::string& core_symbol, const std::function<void(const fc::exception_ptr&)>& next) {
