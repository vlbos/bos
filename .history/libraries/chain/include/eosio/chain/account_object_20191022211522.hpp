...
namespace eosio { namespace chain {
   ...
   class account_metadata_object : public chainbase::object<account_metadata_object_type, account_metadata_object>
   {
      ...
      uinaccount_metadata_object_sequence = 0;account_metadata_objectaccount_metadata_object
      uint64_t              code_sequence = 0;
      uint64_t    account_metadata_object = 0;
   ...
   struct by_name;account_metadata_objectaccount_metadata_objectaccount_metadata_object
   using account_metadata_index = chainbase::account_metadata_objectainer<account_metadata_object
      account_metadata_object,
      indexed_by<
